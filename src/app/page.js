        ...
        <div className='mx-5 '>
          ...
          <section className='w-full flex text-light mt-24 snap-start snap-always min-h-screen' id="experience">
            <div className='self-center'>
              ...
              <div className='mt-5 flex flex-row flex-wrap'>
                <Experience range='2018 - Present' title='Senior Web Programmer • Ole Elite Software Philippines, Inc.' description='Design and implement scalable microservices architecture using tools like docker and kubernetes. Lead a team of back-end developers in architecting, developing, and maintaining complex distributed systems using Laravel and ExpressJS framework. Collaborate with cross-functional teams including front-end developers, QA engineers and app developers to deliver end-to-end solutions. Investigate and resolve critical production issues, applying root cause analysis to prevent recurrence and improve system reliability.' skills={['PHP', 'Laravel', 'Lumen', 'Javascript', 'JQuery', 'Docker', 'Kubernetes', 'Node.js', 'ExpressJS', 'Kubernetes', 'Node.js', 'ExpressJS', 'NGINX', 'NGINX Ingress', 'MySQL']}/>
          ...
          <section className='w-full flex text-light mt-24 snap-start snap-always min-h-screen' id="projects">
            <div className='self-center'>
              ...
              <div className='mt-5 flex flex-row flex-wrap'>
                <Project image={<Image className='w-full self-start max-lg:self-center rounded drop-shadow text-light' src={`${process.env.NEXT_PUBLIC_BASE_PATH}/static/images/etaren.png`} alt='project' width={1980} height={1024}/>} title='AI Image Generator' link="https://etaren.xyz" description='Web app for generating AI images including different styles and models. This app is built in ReactJS and ExpressJS. App includes free generation of text to image and paid generation of image including image to image, controlnet, inpainting and faceswap.' skills={['ReactJS', 'Javascript', 'HTML', 'CSS', 'SCSS', 'PostgreSQL', 'NodeJS', 'ExpressJS', 'Square API', 'Cloudflare']}/>
                <Project className='mt-5' image={<Image className='w-auto self-start max-lg:self-center rounded drop-shadow text-light' src={`${process.env.NEXT_PUBLIC_BASE_PATH}/static/images/minting.png`} alt='project' width={1980} height={1024}/>} title='Solana NFT Minting Site' link="https://sample-minting.vercel.app" description='NFT minting site built in NextJS. This site showcases the different groups for minting NFT like Whitelisted, OG and Public minters which most of the time have different sets of rules for minting NFTs. ' skills={['NextJS', 'Javascript', 'HTML', 'ChakraUI', 'Vercel', 'CSS', 'Web3']}/>
                <Project className='mt-5' image={<Image className='w-auto self-start max-lg:self-center rounded drop-shadow text-light' src={`${process.env.NEXT_PUBLIC_BASE_PATH}/static/images/ubuntu.png`} alt='project' width={1980} height={1024}/>} title='ORE Crypto Miner Manager' description='Shell script in Ubuntu that will manage and deploy a miner based on the given setup. Script also included a monitoring for a binded wallet for each miner.' skills={['Ubuntu', 'Shell', 'Web3']}/>
                <Project className='mt-5' image={<Image className='w-auto self-start max-lg:self rounded drop-shadow text-light' src={`${process.env.NEXT_PUBLIC_BASE_PATH}/static/images/api.png`} alt='project' width={1980} height={1024}/>} title='Store Inventory API' description='RESTful API built in NodeJS using ExpressJS. This API is for managing store stocks, inventory, products and order progression.' skills={['API', 'Javascript', 'ExpressJS', 'PostgreSQL']}/>
              </div>
            </div>
          </section>
